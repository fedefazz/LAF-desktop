...
angular
    ...
    .controller('SubConceptsController', function ($scope, APIService, $window, $cookies, $route, DTOptionsBuilder, DTColumnBuilder, AlertService, $rootScope, $filter, $http) {
        ...
        $scope.dtColumns = [
            DTColumnBuilder.newColumn('ParentName', 'Rubro').renderWith(renderParent),
            DTColumnBuilder.newColumn('Name', 'Sub-Rubro').renderWith(renderTitle)
        ];
        ...
        function serverData(sSource, aoData, fnCallback, oSettings) {
            ...
            //query constructor
            var qs = "?q=" + q + " AND Type:Concept AND IsEnabled:true&fq=ParentKeywordId:*&start=" + aoData[3].value + "&rows=" + aoData[4].value + "&fl=Id,Name,Key,ParentName&sort=" + sort;
        ...
        function renderParent(data, type, full, meta) {
            var html = '<a href="/#/cms/config/subconcepts/crud/' + full.Id + '"><strong>' + full.ParentName + '</strong></a>';
            return html;
        }
        ...
        function renderTitle(data, type, full, meta) {
            ...
            html += '<a href="/#/cms/config/subconcepts/crud/' + full.Id + '"><strong>' + full.Name + '</strong></a>';
            return html;
        }
    ...
    .controller('SubConceptsCRUDController', function ($scope, APIService, $window, $cookies, $rootScope, $mdDialog, AlertService, $stateParams, $localStorage, DTOptionsBuilder, DTColumnBuilder) {
        ...
        //labels
        if (id) {
            $scope.PageTitle = 'Editar Sub-Rubro';
            $scope.SubmitButton = 'Actualizar Sub-Rubro';
        } else {
            $scope.PageTitle = 'Crear Sub-Rubro';
            $scope.SubmitButton = 'Crear Sub-Rubro';
        }
        ...
        if (id) {
            ...
            servCall.then(function (u) {
                ...
                $window.location.href = "/#/cms/config/subconcepts/list";
            });
        }
        ...
        function getBrands() {
            var servCallType = APIService.getConcepts();
        ...
        $scope.processForm = function () {
            ...
            if (id) {
                ...
                servCall.then(function (u) {
                    ...
                    $window.location.href = "/#/cms/config/subconcepts/crud/" + keywordData.Id;
                }, function (error) {
                    $scope.errorMessage = "Oops, something went wrong.";
                });
            }
