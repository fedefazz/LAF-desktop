    ...
    .controller('DashboardController', function ($scope, APIService, $localStorage, $window, $filter) {
        ...
        servCall.then(function (u) {
            ...
            servCallUser.then(function (e) {
                ...
                if (usersroles?.indexOf("Admin") === -1 || usersroles?.indexOf("Employee") === -1) {
        ...
        CallTotalPlantaCerradas.then(function (u) {
            ...
            console.log($scope.totalCerradas);
        ...
        CallTotalAreaImpresionTotal.then(function (u) {
            ...
            console.log($scope.ImpresionTotal);
        ...
        CallTotalAreaLaminacionTotal.then(function (u) {
            ...
            console.log("LaminacionTotal: ",$scope.LaminacionTotal);
            ...
            console.log('datadonnut', $scope.datadonnut);
        ...
        CallTotalGetImpresionDetalle.then(function (u) {
            ...
            console.log("visitors-line-chart",$scope.GetImpresionDetalle);
        ...
        CallTotalLaminacionDetalle.then(function (u) {
            ...
            console.log("visitors-line-chart2",$scope.GetLaminacionDetalle);
            ...
            Morris.Line({
                ...
                ykeys: ['LAMINADORA_2', 'LAMINADORA_3', 'LAMINADORA_4', 'LAMINADORA_5'],
                xLabelFormat: function (x) {
                    x = month[x.getMonth()];
                    return x.toString();
                },
                labels: ['Laminadora 2', 'Laminadora 3', 'Laminadora 4', 'Laminadora 5'],
                lineColors: [red, orange, blueLight, greenLight],
                pointFillColors: [red, orange, blueLight, greenLight],
                lineWidth: '2px',
                pointStrokeColors: [red, orange, blueLight, greenLight],
        ...
        CallTotalIndicadoresTotalesOp.then(function (u) {
            ...
            console.log($scope.IndicadoresTotalesOp);
        ...
        CallTotalIndicadoresTotalScrap.then(function (u) {
            ...
            console.log($scope.IndicadoresTotalScrap);
        ...
        CallTotalAreaImpresion.then(function (u) {
            ...
            console.log($scope.totalAreaImpresion);
        ...
        CallTotalAreaCorte.then(function (u) {
            ...
            console.log($scope.totalAreaCorte);
        ...
        CallTotalAreaMangas.then(function (u) {
            ...
            console.log($scope.totalAreaMangas);
        ...
        CallTotalAreaDoypack.then(function (u) {
            ...
            console.log($scope.totalAreaDoypack);
        ...
        CallTotalAreaTabaco.then(function (u) {
            ...
            console.log($scope.totalAreaTabaco);
        ...
        CallTotalAreaLaminado.then(function (u) {
            ...
            console.log($scope.totalAreaLaminado);
