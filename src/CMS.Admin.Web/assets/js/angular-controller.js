...
/* -------------------------------
   9.0 CONTROLLER - Dashboard v2
------------------------------- */
app.controller('dashboardV2Controller', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        /* Line Chart
        ------------------------- */
        var green = '#0D888B';
...
/* -------------------------------
   10.0 CONTROLLER - Email Inbox v1
------------------------------- */
app.controller('emailInboxController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   11.0 CONTROLLER - Email Inbox v2
------------------------------- */
app.controller('emailInboxV2Controller', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
...
/* -------------------------------
   12.0 CONTROLLER - Email Compose
------------------------------- */
app.controller('emailComposeController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
...
/* -------------------------------
   13.0 CONTROLLER - Email Detail
------------------------------- */
app.controller('emailDetailController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
});
...
/* -------------------------------
   14.0 CONTROLLER - UI Modal & Notifications
------------------------------- */
app.controller('uiModalNotificationController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        /* Gritter Notification
        ------------------------- */
...
/* -------------------------------
   15.0 CONTROLLER - UI Tree
------------------------------- */
app.controller('uiTreeController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
...
/* -------------------------------
   16.0 CONTROLLER - UI Language Bar
------------------------------- */
app.controller('uiLanguageBarIconController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   17.0 CONTROLLER - Form Plugins
------------------------------- */
app.controller('formPluginsController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        /* Datepicker
        ------------------------- */
...
/* -------------------------------
   18.0 CONTROLLER - Form Slider + Switcher
------------------------------- */
app.controller('formSliderSwitcherController', function($scope, $rootScope, $state) {   
    angular.element(document).ready(function () {
        var green = '#00acac',
        red = '#ff5b57',
        blue = '#348fe2',
...
/* -------------------------------
   19.0 CONTROLLER - Form Validation
------------------------------- */
app.controller('formValidationController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   20.0 CONTROLLER - Table Manage Default
------------------------------- */
app.controller('tableManageDefaultController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
...
/* -------------------------------
   21.0 CONTROLLER - Table Manage Autofill
------------------------------- */
app.controller('tableManageAutofillController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                autoFill: true,
...
/* -------------------------------
   22.0 CONTROLLER - Table Manage Buttons
------------------------------- */
app.controller('tableManageButtonsController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                dom: 'Bfrtip',
...
/* -------------------------------
   23.0 CONTROLLER - Table Manage ColReorder
------------------------------- */
app.controller('tableManageColReorderController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                colReorder: true,
...
/* -------------------------------
   24.0 CONTROLLER - Table Manage Fixed Columns
------------------------------- */
app.controller('tableManageFixedColumnsController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                scrollY:        300,
...
/* -------------------------------
   25.0 CONTROLLER - Table Manage Fixed Header
------------------------------- */
app.controller('tableManageFixedHeaderController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                lengthMenu: [20, 40, 60],
...
/* -------------------------------
   26.0 CONTROLLER - Table Manage KeyTable
------------------------------- */
app.controller('tableManageKeyTableController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                scrollY: 300,
...
/* -------------------------------
   27.0 CONTROLLER - Table Manage Responsive
------------------------------- */
app.controller('tableManageResponsiveController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                responsive: true
...
/* -------------------------------
   28.0 CONTROLLER - Table Manage RowReorder
------------------------------- */
app.controller('tableManageRowReorderController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                responsive: true,
...
/* -------------------------------
   29.0 CONTROLLER - Table Manage Scroller
------------------------------- */
app.controller('tableManageScrollerController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
...
/* -------------------------------
   30.0 CONTROLLER - Table Manage Select
------------------------------- */
app.controller('tableManageSelectController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                select: true,
...
/* -------------------------------
   31.0 CONTROLLER - Table Manage Extension Combination
------------------------------- */
app.controller('tableManageCombineController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        if ($('#data-table').length !== 0) {
            $('#data-table').DataTable({
                dom: 'lBfrtip',
...
/* -------------------------------
   32.0 CONTROLLER - Flot Chart
------------------------------- */
app.controller('chartFlotController', function($scope, $rootScope, $state) {
    /* Basic Chart
    ------------------------- */
    var d1 = [], d2 = [], d3 = [];
...
/* -------------------------------
   33.0 CONTROLLER - Morris Chart
------------------------------- */
app.controller('chartMorrisController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        /* Morris Line Chart
        ------------------------- */
        var tax_data = [
...
/* -------------------------------
   34.0 CONTROLLER - Chart JS
------------------------------- */
app.controller('chartJsController', function($scope, $rootScope, $state) {
    // white
...
/* -------------------------------
   35.0 CONTROLLER - Chart d3
------------------------------- */
app.controller('chartD3Controller', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
...
/* -------------------------------
   36.0 CONTROLLER - Calendar
------------------------------- */
app.controller('calendarController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
...
/* -------------------------------
   37.0 CONTROLLER - Vector Map
------------------------------- */
app.controller('mapVectorController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
...
app.controller('mapGoogleController', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageContentFullWidth = true;
...
/* -------------------------------
   39.0 CONTROLLER - Gallery V1
------------------------------- */
app.controller('galleryController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
...
/* -------------------------------
   40.0 CONTROLLER - Gallery V2
------------------------------- */
app.controller('galleryV2Controller', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
	    $('.superbox').SuperBox();
	});
});
...
/* -------------------------------
   55.0 CONTROLLER - Timeline
------------------------------- */
app.controller('extraTimelineController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
        var mapDefault;
...
/* -------------------------------
   56.0 CONTROLLER - Coming Soon
------------------------------- */
app.controller('comingSoonController', function($scope, $rootScope, $state) {
...
/* -------------------------------
   58.0 CONTROLLER - Login V1
------------------------------- */
app.controller('loginV1Controller', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.paceTop = true;
...
/* -------------------------------
   59.0 CONTROLLER - Login V2
------------------------------- */
app.controller('loginV2Controller', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.paceTop = true;
...
/* -------------------------------
   61.0 CONTROLLER - Register V3
------------------------------- */
app.controller('registerV3Controller', function($scope, $rootScope, $state) {
    $rootScope.setting.layout.pageWithoutHeader = true;
    $rootScope.setting.layout.paceTop = true;
    $rootScope.setting.layout.pageBgWhite = true;
...
/* -------------------------------
   62.0 CONTROLLER - Summernote
------------------------------- */
app.controller('summernoteController', function($scope, $rootScope, $state) {
    angular.element(document).ready(function () {
